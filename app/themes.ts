...
export const themes: CustomFlowbiteTheme = {
  button: {
    ...
    color: {
      ...
      "bookadot-primary": "bg-accent-color text-text-primary-color font-bold shadow-[0_4px_16px_0_rgba(255,128,54,0.25)]",
    },
    ...
    label:
      "ml-2 inline-flex h-4 w-4 items-center justify-center bg-cyan-200 text-xs font-semibold text-cyan-800",
    outline: {
      color: {
  ...
  dropdown: {
    ...
    floating: {
      ...
      style: {
        ...
        auto: "border border-gray-200 bg-white text-gray-900 dark:border-border-color dark:bg-background-color dark:text-white",
      },
      target: "w-fit",
    },
  ...
  badge: {
    "root": {
      ...
      "color": {
        ...
        "bookadot-primary": "bg-accent-color"
      },
      "href": "group",
      "size": {
        "xs": "p-1 text-xs",
